...
*Implementations similar to `position: sticky`*
 ...
 - [react-sticky-node](https://github.com/visortelle/react-sticky-node) - `<StickyNode />` - Simplest React sticky component with all directions support and minimalistic API.
