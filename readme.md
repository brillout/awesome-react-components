...
*Implementations similar to `position: sticky`*
 - [react-sticky-state](https://github.com/soenkekluth/react-sticky-state) - &lt;Sticky /&gt; component adds state to native position:sticky polyfills the missing sticky browser feature
